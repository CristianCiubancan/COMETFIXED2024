...
namespace Comet.Game.Packets
{
    ...
    public sealed class MsgRegister : MsgBase<Client>
    {
        ...
        {
            await Log.WriteLogAsync(LogLevel.Info, "[Character creation] - Processing character creation request from {0}", CharacterName);
            ...
            await Log.WriteLogAsync(LogLevel.Info, "[Character creation] - Validated character creation request from {0}", CharacterName);
            ...
            await Log.WriteLogAsync(LogLevel.Info, "[Character creation] - Validated character name availability for {0}", CharacterName);
            if (!Kernel.IsValidName(CharacterName))
            {
                await client.SendAsync(RegisterInvalid);
                return;
            }
            await Log.WriteLogAsync(LogLevel.Info, "[Character creation] - Validated character name format for {0}", CharacterName);
            ...
            await Log.WriteLogAsync(LogLevel.Info, "[Character creation] - Validated character creation input for {0}", CharacterName);
            ...
            await Log.WriteLogAsync(LogLevel.Info, "[Character creation] - Validated point allotment for {0}", CharacterName);
            ...
            await Log.WriteLogAsync(LogLevel.Info, "[Character creation] - Validated character creation for {0}", CharacterName);
            ...
            await Log.WriteLogAsync(LogLevel.Info, "[Character creation] - Validated character body for {0}", CharacterName);
            ...
            try
            {
                await Log.WriteLogAsync(LogLevel.Info, "[Character creation] - Saving character creation for {0}", CharacterName);
            ...
            {
                await Log.WriteLogAsync(LogLevel.Error, "[Character creation] - Failed to save character creation for {0}", CharacterName);
            ...
            try
            {
                await Log.WriteLogAsync(LogLevel.Info, "[Character creation] - Generating initial status for user {0}", CharacterName);
            ...
            await Log.WriteLogAsync(LogLevel.Info, "[Character creation] - Character created sending OK {0}", CharacterName);
            await client.SendAsync(RegisterOk);
            await Log.WriteLogAsync(LogLevel.Info, "[Character creation] - Character created OK sent {0}", CharacterName);
        }
